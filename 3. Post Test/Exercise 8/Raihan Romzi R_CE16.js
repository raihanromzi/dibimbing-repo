...
// so create a function that will return true if they walk the app gives you will take you exactly ten minutes
...
const isValidWalk = (walk) => {
  ...
  const count = (dir, walk) => {
    return walk.filter((value) => {
      return value === dir
    }).length
  }

  return walk.length === 10 && count('n', walk) === count('s', walk) && count('w', walk) === count('e', walk)
}
